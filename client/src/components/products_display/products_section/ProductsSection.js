...
const ProductsSection = () => {
    const {filteredProducts, allProducts, setFilteredProducts} = useContext(AppContext)
        ...
        return (
            <div className='products-section'>
                ...
                <div className='products-container'>
                  {filteredProducts.slice(0,9).map(product => <Product product={product} key={product._id} />)}
                </div>
